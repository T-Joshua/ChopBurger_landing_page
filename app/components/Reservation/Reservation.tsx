...
const Reservation = () => {
  return (
    <div className="pt-[5rem] relative mt-[2rem] pb-[5rem] mb-[3rem] bg-[url('../public/images/b_bg.jpg')] bg-center bg-cover">
     {/* overlay */}
      <div className="absolute w-full h-full bg-[#000000e6] top-0 left-0 right-0 bottom-0 opacity-[80]"></div>
      <div className="w-[80%] relative z-[20] grid grid-cols-1 lg:grid-cols-2 items-center gap-[3rem] mx-auto">
               ...
               <div className="">
                    ...
                    <p className='text-[17px] mt-[1rem] text-white text-opacity-50'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Architecto, voluptatem est illo sit obcaecati, placeat sequi, autem ducimus sunt expedita beatae cumque cum nesciunt consequuntur delectus maxime odit? Esse odio exercitationem minus. Sequi, nobis dolores.</p>
                    <div className="flex mt-[2rem] items-center space-x-4">
                         ...
                         <div>
                              ...
                              <h1 className='text-yellow-200 text-[30px] font-bold'>+0123 456 789</h1>
