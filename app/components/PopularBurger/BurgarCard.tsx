...
const BurgarCard = ({title,image,price,reviews}:Props) => {
  return (
    <div className='bg-white p-6 rounded-lg m-3'>
      ...
      <p className="mt-[0.5rem] text-black text-opacity-70">Lorem ipsum dolor sit amet consectetur.</p>
